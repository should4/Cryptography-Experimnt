...
public:
    ...
    // TEST
    void Test1(const unsigned char in[], unsigned char out[]);
    ...
    // TEST
    void Test_1(const unsigned char in[], unsigned char out[]);
    void Test_2(const unsigned char key[], unsigned char w[], const unsigned char in[], unsigned char out[]);
};
