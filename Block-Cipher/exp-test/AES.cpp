...
void AES::Test_1(const unsigned char in[], unsigned char out[])
{
    unsigned char state[4][Nb];
    unsigned int i, j, round;
...
void AES::Test_2(const unsigned char key[], unsigned char w[], const unsigned char in[], unsigned char out[])
{
    KeyExpansion(key, w);
